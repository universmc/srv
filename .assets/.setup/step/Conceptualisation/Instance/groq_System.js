...
const subject = process.argv[2] || 'Groq_initialisation_Role-System'; //  Obtenir le sujet via l'argument de ligne de commande
...
const subjects = [
  "how-Groq_initialisation_GROQ-SDK",
  "how-GROQ-SDK-Role-System",
...
async function main() {
  for (const subject of subjects) {
    try {
      ...
      const outputFilePath = `Role-${subject}_` + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
