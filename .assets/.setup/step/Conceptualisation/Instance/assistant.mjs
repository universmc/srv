...
const completion = await groq.chat.completions.create({
  ...
  const outputFilePath = "Role_assistant" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
