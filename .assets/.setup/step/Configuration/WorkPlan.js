...
const subject = process.argv[2] || 'System-Howto'; //  Obtenir le sujet via l'argument de ligne de commande
...
const subjects = [
  "Groq_initialisation_GROQ-SDK",
  "GROQ-SDK-Role-system",
  "GROQ-SDK-Role-assistant",
  "GROQ-SDK-Role-user",
  "GROQ-SDK-Role-INSTANCE",
  "GROQ-SDK-IA+ML-Brainstroming",
  "Groq-IA+ML-intro-dev-Step-Configuration_PulicConfig",
  "Groq-IA+ML-intro-dev-Step-Configuration_ServeurConfig",
  "Groq-IA+ML-intro-dev-DevOps-Rechercher",
  "Groq-IA+ML-intro-dev-Phase-Conceptualisation",
  "Groq-IA+ML-intro-dev-Module-Connection",
  "Groq-IA+ML-intro-dev-Module-Scring",
  "Groq-IA+ML-intro-dev-Module-Tensoflow",
  "Groq-IA+ML-intro-dev-Epoch-Entrainnement",
  "Groq-IA+ML-intro-dev-Iteration-Frontent",
  "Groq-IA+ML-intro-dev-Iteration-Backend",
  "Groq-IA+ML-intro-dev-Iteration-Documentation",
  "Groq-IA+ML-intro-dev-contrubution-Promotions",
];
...
async function main() {
  for (const subject of subjects) {
    try {
      ...
      const outputFilePath = `howTo_${subject}_` + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
